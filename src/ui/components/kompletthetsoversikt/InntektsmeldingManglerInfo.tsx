    ...
    <>
        <Box marginBottom={Margin.large}>
            <Alert variant="warning" size="medium" className={styles.alert}>
                ...
                <BodyLong>
                    Inntektsmelding mangler for en eller flere arbeidsgivere, eller for ett eller flere arbeidsforhold
                    ...
                    <Alert variant="info" size="medium">
                        ...
                        <Accordion.Content>
                            ...
                            <ul className={styles.kompletthet__list}>
                                ...
                                <li>
                                    Det ikke er rapportert lønn hos arbeidsforholdet de siste 3 månedene før
                                    skjæringstidspunktet. Beregningsgrunnlaget for denne arbeidsgiveren vil settes til
                                    0,-.
                                </li>
                                <li>
                                    Måneden for skjæringstidspunktet er innrapportert til A-ordningen. Hvis det er
                                    innrapportert lavere lønn enn foregående måneder kan det tyde på at arbeidsgiver
                                    ikke lenger utbetaler lønn. Det er dermed lavere risiko for at arbeidsgiver vil
                                    kreve refusjon.
                                </li>
                            </ul>
                            <Box marginTop={Margin.large}>
                                ...
                                <ul className={styles.kompletthet__list}>
                                    <li>
                                        ...
                                        Aa-registeret). I disse tilfellene trenger vi inntektsmelding for å skille hva
                                        som er arbeidsinntekt og frilansinntekt i samme organisasjon.
                                    </li>
                                    <li>
